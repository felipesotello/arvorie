...
function atualiza() {
	...
	document.getElementById('hubspot_coverage_zero_to_five').value = coverage_zero_to_five.checked;
	...
	document.getElementById('hubspot_coverage_babysitter').value = coverage_babysitter.checked;
	document.getElementById('hubspot_coverage_summer_camp').value = coverage_summer_camp.checked;
	document.getElementById('hubspot_contribution_pppm').value = contributionPppm;
	document.getElementById('hubspot_contribution_monthly').value = contribution_monthly;
	document.getElementById('hubspot_contribution_yearly').value = contribution_yearly;
	document.getElementById('hubspot_federal_tax_credit').value = federal_tax_credit;
	document.getElementById('hubspot_federal_tax_shield').value = federal_tax_shield;
	document.getElementById('hubspot_federal_tax_savings').value = federal_tax_savings;
	document.getElementById('hubspot_state_tax_credit_ny').value = state_tax_credit_ny;
	document.getElementById('hubspot_state_tax_credit_sc').value = state_tax_credit_sc;
	document.getElementById('hubspot_state_tax_credit_ms').value = state_tax_credit_ms;
	document.getElementById('hubspot_state_tax_credit_nm').value = state_tax_credit_nm;
	document.getElementById('hubspot_state_tax_credit_ks').value = state_tax_credit_ks;
	document.getElementById('hubspot_state_tax_credit_ri').value = state_tax_credit_ri;
	document.getElementById('hubspot_state_tax_shield_ny').value = state_tax_shield_ny;
	document.getElementById('hubspot_state_tax_shield_sc').value = state_tax_shield_sc;
	document.getElementById('hubspot_state_tax_shield_ms').value = state_tax_shield_ms;
	document.getElementById('hubspot_state_tax_shield_nm').value = state_tax_shield_nm;
	document.getElementById('hubspot_state_tax_shield_ks').value = state_tax_shield_ks;
	document.getElementById('hubspot_state_tax_shield_ri').value = state_tax_shield_ri;
	document.getElementById('hubspot_state_tax_shield_other').value = state_tax_shield_other;
	document.getElementById('hubspot_state_tax_credit').value = state_tax_credit;
	document.getElementById('hubspot_state_tax_shield').value = state_tax_shield;
	document.getElementById('hubspot_state_tax_savings').value = state_tax_savings;
	document.getElementById('hubspot_tax_benefit').value = tax_benefit;
	document.getElementById('hubspot_net_cost_pppm').value = net_cost_pppm;
	document.getElementById('hubspot_net_cost_monthly').value = net_cost_monthly;
	document.getElementById('hubspot_net_cost_yearly').value = net_cost_yearly;
	document.getElementById('hubspot_salary_equivalent_pppm').value = salary_equivalent_pppm;
	document.getElementById('hubspot_salary_equivalent_monthly').value = salary_equivalent_monthly;
	document.getElementById('hubspot_salary_equivalent_yearly').value = salary_equivalent_yearly;
}
